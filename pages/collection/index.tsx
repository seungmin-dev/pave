          ...
          <div>
            <ul className="">
              {new Array(20).fill(1).map((el, i) => (
                <li
                  key={i}
                  className="p-3 border-b-[1px] border-zinc-200 flex justify-between items-center"
                >
                  <span className="pl-3">음악 어쩌구</span>
                  <button className="bg-black text-white py-1 px-3 rounded-full cursor-pointer hover:opacity-70">
                    PAVING
                  </button>
                </li>
              ))}
